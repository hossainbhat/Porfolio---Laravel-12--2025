    ...
    <div id="grid-gallery" class="container grid-gallery">
        ...
        <section class="grid-wrap">
            <ul class="row grid">
                ...
                <li>
                    <figure>
                        <img src="{{asset('frontend/img/projects/project-1.jpg')}}" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{asset('frontend/img/projects/project-2.jpg')}}" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{asset('frontend/img/projects/project-3.jpg')}}" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{asset('frontend/img/projects/project-4.jpg')}}" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{asset('frontend/img/projects/project-5.jpg')}}" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{asset('frontend/img/projects/project-6.jpg')}}" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{asset('frontend/img/projects/project-7.jpg')}}" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{asset('frontend/img/projects/project-8.jpg')}}" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{asset('frontend/img/projects/project-9.jpg')}}" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends --> --}}
