            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2" style="float: right;">
                        <a href="{{ route('experiences.create') }}" class="btn btn-primary btn-sm"><i
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var dataTable = $('#dataTable').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, col) {
                            ...
                            returnData += '<a href="' + utlt.siteUrl('admin/experiences/' + data +
                                    '/edit') +
                ...
                ajax: {
                    url: utlt.siteUrl("admin/experiences"),
                },
            ...
            $(document).on('click', '.deleteItem', function() {
                ...
                Swal.fire(config).then(function(result) {
                    if (result.value === true) {
                        utlt.Delete('admin/experiences/' + $el.attr('data-val'), '#dataTable');
                    }
                });
            });
