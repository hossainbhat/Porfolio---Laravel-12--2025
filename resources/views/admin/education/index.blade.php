            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2" style="float: right;">
                        <a href="{{ route('education.create') }}" class="btn btn-primary btn-sm"><i
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var dataTable = $('#dataTable').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, col) {
                            ...
                            returnData += '<a href="' + utlt.siteUrl('admin/education/' + data +
                                    '/edit') +
                ...
                ajax: {
                    url: utlt.siteUrl("admin/education"),
                },
            ...
            $(document).on('click', '.deleteItem', function() {
                ...
                Swal.fire(config).then(function(result) {
                    if (result.value === true) {
                        utlt.Delete('admin/education/' + $el.attr('data-val'), '#dataTable');
                    }
                });
            });
