 ...
 * @return
 */
// function sendError($message = 'Whoops, looks like something went wrong! Please try again.')
// {
//     $payload = [
//         'message' => $message
//     ];
//     return sendJson(511, false, config('rest.response.error.code'), $payload, 'error');
// }
